    ...
    return (
        <div className="bg-white w-[600px] p-[30px] pb-[100px] mt-4 rounded-lg border border-solid border-[#dedede] shadow-sm">
            ...
            <div className="flex justify-between mt-[30px]">
                <small className="text-[blue] text-sm hover:text-[#f60] cursor-pointer ">Bạn quên mật khẩu ?</small>
                <Link to={'/register'}>
                    <small className="text-[blue] text-sm hover:text-[#f60] cursor-pointer ">Tạo tài khoản mới</small>
                </Link>
            </div>
        </div>
    );
